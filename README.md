...
3,896 employers tracked · updated Aug 02, 2026 at 08:20 UTC
...
_Engine (last run): 3,721 of 3,989 registered boards returned successfully across 12 ATS platforms (98% of boards attempted, 93% of the full registry) · completed in 368.6s · 89 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
