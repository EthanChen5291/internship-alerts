...
3,883 employers tracked · updated Aug 01, 2026 at 06:27 UTC
...
_Engine (last run): 2,545 of 3,975 registered boards returned successfully across 12 ATS platforms (67% of boards attempted, 64% of the full registry) · completed in 165.4s · 28 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
