...
### 226 open roles (185 listed below) · 82 new this week

4,225 employers tracked · data as of Aug 18, 2026 at 20:51 UTC

_141 have a cycle the employer stated · 85 are recent postings whose cycle isn't stated (listed separately, never mixed in)._
...
|---|---|---|---|---|
| Anduril | 2027 Software Engineer Intern | Summer 2027 | 2026-08-18 | out of scope |
...
_Engine (last run): 4,097 of 4,468 registered boards returned successfully across 12 ATS platforms (98% of boards attempted, 91% of the full registry) · completed in 883.6s · 540 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
