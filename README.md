...
4,079 employers tracked · data as of Aug 09, 2026 at 16:00 UTC
...
_Engine (last run): 3,976 of 4,315 registered boards returned successfully across 12 ATS platforms (97% of boards attempted, 92% of the full registry) · completed in 944.6s · 535 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
