...
### 244 open roles (196 listed below) · 73 new this week

4,271 employers tracked · data as of Aug 24, 2026 at 08:39 UTC

_156 have a cycle the employer stated · 88 are recent postings whose cycle isn't stated (listed separately, never mixed in)._
...
| InfiniteQuant 🆁 | Quantitative Developer - Internship - Summer 2027 🆕 _(2 openings)_ | Quant | New York +2 more | Python, C++ | Aug 19, 2026 | [Apply](https://jobs.smartrecruiters.com/InfiniteQuant/744000144281579) [#2](https://jobs.smartrecruiters.com/InfiniteQuant/744000145205764) |
...
_Engine (last run): 4,139 of 4,514 registered boards returned successfully across 12 ATS platforms (98% of boards attempted, 91% of the full registry) · completed in 914.1s · 547 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
