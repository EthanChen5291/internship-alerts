...
4,478 employers tracked · data as of Sep 05, 2026 at 21:23 UTC
...
_Engine (last run): 4,352 of 4,726 registered boards returned successfully across 13 ATS platforms (98% of boards attempted, 92% of the full registry) · completed in 1025.2s · 588 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
