...
### 225 open roles (184 listed below) · 80 new this week

4,225 employers tracked · data as of Aug 18, 2026 at 16:00 UTC

_142 have a cycle the employer stated · 83 are recent postings whose cycle isn't stated (listed separately, never mixed in)._
...
_Engine (last run): 4,152 of 4,468 registered boards returned successfully across 12 ATS platforms (98% of boards attempted, 92% of the full registry) · completed in 1037.0s · 568 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
