...
4,271 employers tracked · data as of Aug 25, 2026 at 08:12 UTC
...
_Engine (last run): 4,011 of 4,514 registered boards returned successfully across 12 ATS platforms (95% of boards attempted, 88% of the full registry) · completed in 961.5s · 517 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
