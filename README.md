...
4,081 employers tracked · data as of Aug 10, 2026 at 11:35 UTC
...
_Engine (last run): 3,974 of 4,317 registered boards returned successfully across 12 ATS platforms (97% of boards attempted, 92% of the full registry) · completed in 997.8s · 541 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
