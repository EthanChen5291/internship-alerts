...
4,078 employers tracked · data as of Aug 09, 2026 at 05:34 UTC
...
| ⚙️ **An engine, not a spreadsheet** | 4,314 job-board endpoints (4,078 distinct employers; some run more than one board) polled every 30 minutes across 12 ATS platforms. Full source and tests in this repo. |
...
_Engine (last run): 4,027 of 4,314 registered boards returned successfully across 12 ATS platforms (98% of boards attempted, 93% of the full registry) · completed in 1044.9s · 548 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
