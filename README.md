...
### 127 open roles (115 listed below) · 38 new this week

3,828 employers tracked · updated Aug 07, 2026 at 00:29 UTC

_70 have a cycle the employer stated · 57 are recent postings whose cycle isn't stated (listed separately, never mixed in)._
...
| ⚙️ **An engine, not a spreadsheet** | 3,909 job-board endpoints (3,828 distinct employers; some run more than one board) polled every 30 minutes across 12 ATS platforms. Full source and tests in this repo. |
...
_Engine (last run): 3,800 of 3,909 registered boards returned successfully across 12 ATS platforms (98% of boards attempted, 97% of the full registry) · completed in 394.1s · 96 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
