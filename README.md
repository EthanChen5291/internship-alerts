...
### 226 open roles (185 listed below) · 80 new this week

4,225 employers tracked · data as of Aug 18, 2026 at 17:55 UTC
...
_Engine (last run): 4,131 of 4,468 registered boards returned successfully across 12 ATS platforms (98% of boards attempted, 92% of the full registry) · completed in 1017.5s · 549 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
