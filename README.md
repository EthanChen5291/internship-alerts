...
4,183 employers tracked · data as of Aug 15, 2026 at 18:09 UTC
...
_Engine (last run): 3,918 of 4,422 registered boards returned successfully across 12 ATS platforms (94% of boards attempted, 88% of the full registry) · completed in 881.7s · 512 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
