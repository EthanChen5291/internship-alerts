...
### 177 open roles (162 listed below) · 78 new this week

4,139 employers tracked · data as of Aug 13, 2026 at 08:56 UTC

_103 have a cycle the employer stated · 74 are recent postings whose cycle isn't stated (listed separately, never mixed in)._
...
_Engine (last run): 4,032 of 4,376 registered boards returned successfully across 12 ATS platforms (97% of boards attempted, 92% of the full registry) · completed in 946.4s · 545 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
