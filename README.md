...
4,239 employers tracked · data as of Aug 19, 2026 at 19:52 UTC
...
_Engine (last run): 4,162 of 4,482 registered boards returned successfully across 12 ATS platforms (98% of boards attempted, 92% of the full registry) · completed in 1047.2s · 570 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
