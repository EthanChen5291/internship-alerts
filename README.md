...
4,049 employers tracked · data as of Aug 07, 2026 at 12:42 UTC
...
_Engine (last run): 4,047 of 4,285 registered boards returned successfully across 12 ATS platforms (95% of boards attempted, 94% of the full registry) · completed in 956.8s · 582 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
