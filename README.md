...
### 171 open roles (156 listed below) · 73 new this week

4,139 employers tracked · data as of Aug 12, 2026 at 15:27 UTC

_101 have a cycle the employer stated · 70 are recent postings whose cycle isn't stated (listed separately, never mixed in)._
...
_Engine (last run): 4,126 of 4,376 registered boards returned successfully across 12 ATS platforms (99% of boards attempted, 94% of the full registry) · completed in 903.8s · 599 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
