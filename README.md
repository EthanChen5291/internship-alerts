...
4,079 employers tracked · data as of Aug 09, 2026 at 13:26 UTC
...
_Engine (last run): 3,980 of 4,315 registered boards returned successfully across 12 ATS platforms (96% of boards attempted, 92% of the full registry) · completed in 889.7s · 540 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
