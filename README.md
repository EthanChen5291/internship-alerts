...
### 164 open roles (150 listed below) · 75 new this week

4,049 employers tracked · data as of Aug 07, 2026 at 23:29 UTC

_100 have a cycle the employer stated · 64 are recent postings whose cycle isn't stated (listed separately, never mixed in)._
...
_Engine (last run): 4,070 of 4,285 registered boards returned successfully across 12 ATS platforms (99% of boards attempted, 95% of the full registry) · completed in 845.5s · 585 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
