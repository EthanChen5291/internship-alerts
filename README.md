...
### 222 open roles (182 listed below) · 78 new this week
...
## Summer 2027  (77 employer-stated)
...
_Engine (last run): 4,111 of 4,468 registered boards returned successfully across 12 ATS platforms (97% of boards attempted, 92% of the full registry) · completed in 999.4s · 556 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
