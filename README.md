...
### 225 open roles (184 listed below) · 78 new this week

4,225 employers tracked · data as of Aug 18, 2026 at 19:08 UTC
...
_Engine (last run): 4,098 of 4,468 registered boards returned successfully across 12 ATS platforms (98% of boards attempted, 91% of the full registry) · completed in 919.2s · 540 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
